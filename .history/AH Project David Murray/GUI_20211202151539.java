...
public class GUI extends javax.swing.JFrame {
    ...
    public void DealerPlays(BlackJack game) {
        DealerCardImg3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.dealer.getHand().get(2).toString() + ".png")));
        Thread.sleep(500);
        DealerHandValueLabel.setText("?");
    }
