    ...
    public void DealerPlays(BlackJack game) throws InterruptedException {
        ...
        while (game.dealer.handValue() < 17 && game.dealer.getHand().size() < 4) {
            ...
            if (game.dealer.getHand().size() == 2) {
                PlayerCardImg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.dealer.getHand().get(2).toString() + ".png")));
                PlayerHandValueLabel.setText(Integer.toString(p.handValue()));
                HitButton.setPressedFalse();
                ...
                PlayerCardImg4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.dealer.getHand().get(3).toString() + ".png")));
                PlayerHandValueLabel.setText(Integer.toString(p.handValue()));
                HitButton.setPressedFalse();
                if (game.dealer.handValue() > 21) {
                    game.dealer.setBust();
