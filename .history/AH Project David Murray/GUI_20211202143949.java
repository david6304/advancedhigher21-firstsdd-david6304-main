...
public class GUI extends javax.swing.JFrame {
    ...
    public void initialDealFrame(BlackJack game) throws InterruptedException {
        ...
        Thread.sleep(500);
        PlayerCardImg2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.getPlayersArray()[0].getHand().get(0).toString() + ".png")));
        Thread.sleep(500);
        PlayerCardImg3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.getPlayersArray()[0].getHand().get(1).toString() + ".png")));
        Thread.sleep(500);
        DealerHandValueLabel.setText("?");
        PlayerNameLabelValue.setText(game.getPlayersArray()[0].getName());
    ...
    public void playRoundsFrame(BlackJack game) throws InterruptedException {
        ...
        for (Player p : game.getPlayersArray()) {
            while (!StandButton.isPressed() || p.getHand().size() > 3 || p.handValue() > 21) {
                System.out.println(HitButton.isPressed());
                if (HitButton.isPressed()) {
                    game.dealer.Deal(game.pack, p);
                    PlayerCardImg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + game.getPlayersArray()[0].getHand().get(2).toString() + ".png")));
