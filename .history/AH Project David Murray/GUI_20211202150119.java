...
public class GUI extends javax.swing.JFrame {
    ...
    public void playRoundsFrame(BlackJack game) throws InterruptedException {
        ...
        for (Player p : game.getPlayersArray()) {
            ...
            Thread.sleep(500);
            PlayerCardImg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + p.getHand().get(0).toString() + ".png")));
            Thread.sleep(500);
            PlayerCardImg4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/png_96_dpi/" + p.getHand().get(1).toString() + ".png")));
            Thread.sleep(500);
